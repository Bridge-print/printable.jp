...
function hook_enqueue_block_editor_assets() {
	...
	// icons
	wp_enqueue_script( 'swell_icon_ls', T_DIRE_URI . '/build/gutenberg/icons/index.js', [], SWELL_VERSION, true );
	wp_enqueue_script( 'swell_icon_ph', T_DIRE_URI . '/build/gutenberg/icons/ph.js', [], SWELL_VERSION, true );
	wp_enqueue_script( 'swell_icon_fi', T_DIRE_URI . '/build/gutenberg/icons/fi.js', [], SWELL_VERSION, true );
	wp_enqueue_script( 'swell_icon_io', T_DIRE_URI . '/build/gutenberg/icons/io.js', [], SWELL_VERSION, true );
	wp_enqueue_script( 'swell_icon_fa', T_DIRE_URI . '/build/gutenberg/icons/fa.js', [], SWELL_VERSION, true );
